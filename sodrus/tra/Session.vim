...
silent only
silent tabonly
cd ~/source/translations/sod_rus/sodrus/tra
...
argglobal
%argdel
$argadd sod-russian.tra
$argadd sod-english.tra
edit sod-english.tra
...
argglobal
if bufexists("sod-english.tra") | buffer sod-english.tra | else | edit sod-english.tra | endif
balt sod-russian.tra
setlocal keymap=
setlocal noarabic
...
silent! normal! zE
let &fdl = &fdl
let s:l = 40507 - ((13 * winheight(0) + 14) / 28)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 43064 - ((20 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 43064
...
exe '2resize ' . ((&lines * 27 + 29) / 58)
tabnext 1
badd +1 sod-russian.tra
badd +1 sod-english.tra
